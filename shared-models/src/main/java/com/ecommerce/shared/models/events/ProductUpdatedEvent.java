...
public class ProductUpdatedEvent extends DomainEvent {
    ...
    // Fields to track what was changed
    ...
    public ProductUpdatedEvent(String tenantId, String productId, String name, String description,
                              String category, String subcategory, String brand, String sku,
                              BigDecimal price, String currency, Map<String, Object> attributes,
                              String status, String correlationId, Map<String, Object> previousValues,
                              Map<String, Object> updatedFields) {
        super(tenantId, "ProductUpdated");
