...
CREATE TABLE notification_preferences (
    ...
    notification_type ENUM('ORDER_CREATED', 'ORDER_CONFIRMED', 'ORDER_SHIPPED', 'ORDER_DELIVERED', 'ORDER_CANCELLED', 'PAYMENT_SUCCEEDED', 'PAYMENT_FAILED', 'INVENTORY_LOW', 'ACCOUNT_CREATED', 'PASSWORD_RESET', 'PROMOTIONAL') NOT NULL,
    channel ENUM('EMAIL', 'SMS', 'PUSH') NOT NULL,
